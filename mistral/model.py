...
class Attention(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.wq = lora.Linear(args.dim, args.n_heads * args.head_dim, bias=False)
        # self.wk = lora.Linear(args.dim, args.n_kv_heads * args.head_dim, bias=False)
        self.wv = lora.Linear(args.dim, args.n_kv_heads * args.head_dim, bias=False)
        self.wo = lora.Linear(args.n_heads * args.head_dim, args.dim, bias=False)
